...
> [../analysis/performance-baseline.md](../analysis/performance-baseline.md) §4. Every
...
[../migration/04-PHASE-0-PREPARATION.md](../migration/04-PHASE-0-PREPARATION.md)'s
...
([../analysis/api-mapping.md](../analysis/api-mapping.md) §7). Whichever replacement is
...
([../migration/03-TECHNICAL-STACK.md](../migration/03-TECHNICAL-STACK.md), Set C). Adding
...
4. Paste the raw tool output into
   [../analysis/performance-baseline.md](../analysis/performance-baseline.md), not a summary.

## 8. Related

- [../analysis/performance-baseline.md](../analysis/performance-baseline.md) — the measurements
- [testing-strategy.md](./testing-strategy.md)
- [architecture-guidelines.md](./architecture-guidelines.md)
- [../migration/16-RISK-ASSESSMENT.md](../migration/16-RISK-ASSESSMENT.md)
