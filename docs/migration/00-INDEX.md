...
| Phase 3: Core Logic | ⏳ NOT STARTED — but note `MatchState`, `RulesEngine`, `Board` and `GameRules` already exist from Phase 0's PoC and Phase 1, so this phase needs re-scoping against what is there before it is planned | - | - | - |
