package tto.anims 
{
	 ...
	 * @author Mao
	 */
	public class BlueWinAnim extends Sprite 
	{
		private var gfx:Image;
		
		public function BlueWinAnim() 
		{
			super();
		...
		private function init(e:Event):void 
		{
			...
			gfx = new Image(Assets.manager.getTexture('121604.tex'));
		...
		private function predispose():void {
			Starling.juggler.tween(gfx, 0.4, { transition: Transitions.EASE_IN, delay:0.8, alpha:0, onComplete:dispose } );
		}
