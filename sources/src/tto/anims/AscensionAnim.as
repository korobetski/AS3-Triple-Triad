package tto.anims 
{
	 ...
	 * @author Mao
	 */
	public class AscensionAnim extends Sprite 
	{
		private var gfx:Image;
		
		public function AscensionAnim() 
		{
			super();
		...
		private function init(e:Event):void 
		{
			...
			gfx = new Image(Assets.manager.getTexture('121622.tex'));
		...
		private function predispose():void {
			Starling.juggler.tween(gfx, 0.2, {delay:0.4, y:0, alpha:0, onComplete:dispose } );
		}
