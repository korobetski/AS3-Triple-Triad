package tto.anims 
{
	 ...
	 * @author Mao
	 */
	public class StartAnim extends Sprite 
	{
		...
		private function init(e:Event):void 
		{
			...
			gfx = new Image(Assets.manager.getTexture('121601.tex'));
		...
		private function predispose():void {
			Starling.juggler.tween(gfx, 0.4, {delay:0.6, scaleX:2, scaleY:2, alpha:0, onComplete:dispose } );
		}
