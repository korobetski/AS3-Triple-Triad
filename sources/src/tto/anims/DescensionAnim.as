package tto.anims 
{
	 ...
	 * @author Mao
	 */
	public class DescensionAnim extends Sprite 
	{
		private var gfx:Image;
		
		public function DescensionAnim() 
		{
			super();
		...
		private function init(e:Event):void 
		{
			...
			gfx = new Image(Assets.manager.getTexture('121623.tex'));
		...
		private function predispose():void {
			Starling.juggler.tween(gfx, 0.2, {delay:0.4, y:stage.height, alpha:0, onComplete:dispose } );
		}
