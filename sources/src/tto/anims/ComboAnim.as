package tto.anims 
{
	 ...
	 * @author Mao
	 */
	public class ComboAnim extends Sprite 
	{
		private var gfx:Image;
		
		public function ComboAnim() 
		{
			super();
		...
		private function init(e:Event):void 
		{
			...
			gfx = new Image(Assets.manager.getTexture('121618.tex'));
			...
			Starling.juggler.tween(gfx, 0.4, {delay:0.8, scaleX:1, scaleY:1, alpha:1, onComplete:predispose } );
		}
